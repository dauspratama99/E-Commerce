<div class="container">
	<h1 class="well"><center>Pendaftaran Konsumen Toko</center></h1>
			...
			if(isset($_POST['signup'])){
				...
				if(!$error){
					...
					if(mysqli_num_rows($query) > 0){
						...
						?>	
						echo "<meta http-equiv='refresh' content='0; url=<?= BASE_URL ?>/index.php?p=success'>";
...
exit();
	...
	<div class="well"><p class="text-center new-account">Pernah jadi anggota? <a href="<?= BASE_URL ?>/index.php?p=login">Masuk</a></p></div>
</div>