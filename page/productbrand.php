...
<div class="top-products">
	<div class="container">
		<div class="text-right" style="margin-top: 10px;"><a href="<?= BASE_URL ?>/index.php?p=brands"><i class="fa fa-arrow-left"></i> BACK</a></div>
		<div class="row product" style="margin-top: 10px;">
			...
			<div class="col-md-3 col-xs-6 product-left">
				<div class="p-one">
					<a href="#">
						<img src="<?= BASE_URL ?>/miiadmin/img/<?php echo $row['bgimg']; ?>"/>
						<div class="mask">
							<a href="<?= BASE_URL ?>/index.php?p=single&id=<?php echo $row['item_id']; ?>"><span>Lihat Detail</span></a>
						</div>
					</a>
				...
				<nav class="text-center">
					<ul class="pagination">
						...
						for($i=1; $i<=$total_page; $i++){ 
							if($i == $page){
								$number .= "<a href='<?= BASE_URL ?>/index.php?p=productbrand&b=".$row['brand']."&page=$i'>$i</a>";
							}else{
								$number .= "<a href='<?= BASE_URL ?>/index.php?p=productbrand&b=".$row['brand']."&page=$i'>$i</a>";
							}
						}
