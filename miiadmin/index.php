...
<body class="background-black" style="background-color:cyan;">
	<?php
	include "connect.php";
				...
				?>
					<form action="index.php" method="post">
						...
						<div class="form-group input-group groups">
							...
							<input type="password" class="form-control form-input" id="form-password" name="password" placeholder="Password">
						</div>
						
						<span class="text-danger msg-error"><?php echo $passErr; ?></span>
						
						<button type="submit" class="btn btn-lg btn-primary btn-block" name="signin">Log in</button>
					</form>
				</div>
