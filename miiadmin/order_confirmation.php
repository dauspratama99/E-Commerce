							...
							<div class="row" style="margin-bottom: 10px;">
								<div class="col-lg-12" style="margin-bottom:40px;">
									...
									<div class="col-xs-6 text-right" style="margin-top: 10px;">
										<address>
											Jl. Veteran No 28, Padang<br />
											Telepon : 021 23456789<br />
											Email : tokobukuvaria@gmail.com
										</address>
									</div>
									<?php
									...
									<div class="col-lg-12">
													...
													<tr>
														...
														<td>
															<div class="table-column-left">
																<img src="<?= BASE_URL ?>/miiadmin/img/<?php echo $row['bgimg']; ?>" class="img-small">
															</div>
										...
										<div style="margin-top:3%;">
											<p>Terima kasih atas pembelian Anda di Toko Buku Varia, kami senang bahwa Anda telah memilih berbelanja ditempat kami dan kami berharap dapat melayani Anda kembali.</p>
										</div>
									</div>
								</div>
							</div>
